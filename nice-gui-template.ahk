...
Gui, Font, s8
Gui, Add, Text, % "x7 y+10 w" (Width-14) "r1 +0x4000 vTX1 gGeorge", George Harrison
Gui, Add, Text, % "x7 y+10 w" (Width-14) "r1 +0x4000 vTX2 gJohn", John Lennon
Gui, Add, Text, % "x7 y+10 w" (Width-14) "r1 +0x4000 vTX3 gPaul", Paul McCartney
Gui, Add, Text, % "x7 y+10 w" (Width-14) "r1 +0x4000 vTX4 gRingo", Ringo Starr
